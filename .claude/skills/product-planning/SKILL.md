...
在所有表格都完成後（或在使用者希望的階段完成後），提供一個綜合分析：
...
3. 儲存為 `deliverables/<產品名>-report.html`
...
報告產出後，如果使用者需要將企劃成果交付給下游 spec-forge-agent 進行規格化：

1. 提醒使用者：「企劃報告已完成。如果需要進入規格工程階段，可以說『交付』或『handoff』，我會幫你產出一份結構化的 PRD.md，可以直接交給 spec-forge-agent 使用。」
2. 不要自動執行 handoff — 這是使用者的選擇
3. 完整 handoff 流程定義在 `protocols/handoff-to-spec-forge.md`
